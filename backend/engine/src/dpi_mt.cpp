...
std::cout << "\"totalPackets\":" << stats_.total_packets.load() << ",\n";
std::cout << "\"totalBytes\":" << stats_.total_bytes.load() << ",\n";
std::cout << "\"tcpPackets\":" << stats_.tcp_packets.load() << ",\n";
std::cout << "\"udpPackets\":" << stats_.udp_packets.load() << ",\n";
...
for (const auto& [app, count] : sorted_apps) {
    ...
    std::cout << "{";
    std::cout << "\"name\":\"" << appTypeToString(app) << "\",";
...
for(const auto& [sni, app] : stats_.detected_snis){
    ...
    std::cout
        << "{"
        << "\"domain\":\"" << sni << "\","
        << "\"application\":\"" << appTypeToString(app) << "\""
        << "}";
